...
define([
	...
	Assets.prototype.addAsset = function( name, src ){
	    var queue = this._queue, assets = this._assets, asset,
		queueIndex = queue[ name ], index = assets[ name ];
	...
	Assets.prototype.fromJSON = function( json ){
	    var assets = this._assets, asset, jsonAsset,
		key;
