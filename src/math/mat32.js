...
define(
	...
	function Mat32( m11, m12, m13, m21, m22, m23 ){
	    ...
	    */
	    ...
	    te[0] = m11 !== undefined ? m11 : 1; te[2] = m12 || 0; te[4] = m13 || 0;
	    te[1] = m21 || 0; te[3] = m22 !== undefined ? m22 : 1; te[5] = m23 || 0;
	}
	 ...
	 * @method mequals
	 * @memberof Mat32
	 * @brief checks if a's values equal b's values, can be called as a static function Mat32.mequals( a, b )
	 * @param Mat32 a
	 * @param Mat32 b
	 * @return Boolean
	 */
        Mat32.mequals = Mat32.prototype.mequals = function( a, b ){
            var ae = a.elements,
		be = b.elements;
