...
define([
	 ...
	 */
	    ...
	    var te = this.elements,
		m11 = ae[0], m12 = ae[4], m13 = ae[8], m14 = ae[12],
		m21 = ae[1], m22 = ae[5], m23 = ae[9], m24 = ae[13],
		m31 = ae[2], m32 = ae[6], m33 = ae[10], m34 = ae[14],
		m41 = ae[3], m42 = ae[7], m43 = ae[11], m44 = ae[15];
	 ...
	 */
	    ...
	    m11 *= invSx; m12 *= invSy; m13 *= invSz;
	    m21 *= invSx; m22 *= invSy; m23 *= invSz;
	    m31 *= invSx; m32 *= invSy; m33 *= invSz;
	 ...
	 * @return this
	 */
	Mat4.prototype.fromEuler = function( euler ){
	    var te = this.elements,
	 ...
	 * @method mequals
	 * @memberof Mat4
	 * @brief checks if a's values equal b's values, can be called as a static function Mat4.mequals( a, b )
	 * @param Mat4 a
	 * @param Mat4 b
	 * @return Boolean
	 */
        Mat4.mequals = Mat4.prototype.mequals = function( a, b ){
            var ae = a.elements,
		be = b.elements;
