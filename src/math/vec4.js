...
define(
	 ...
	 */
		...
		bx = other.x, by = other.y, bz = other.z, bw = this.w;
	 ...
	 */
		...
		maxx = max.x, maxy = max.y, maxz = max.z, maxw = maxw;
	 ...
	 * @return this
	 */
        Vec4.prototype.untransformMat4 = function( m ){
	    var me = m.elements,
		x = this.x, y = this.y, z = this.z, w = this.w;
            
            this.x = x * me[0] + y * me[1] + z * me[2] + w * me[3];
            this.y = x * me[4] + y * me[5] + z * me[6] + w * me[7];
            this.z = x * me[8] + y * me[9] + z * me[10] + w * me[11];
            this.w = x * me[12] + y * me[13] + z * me[14] + w * me[15];
	 ...
	 * @method vequals
	 * @memberof Vec4
	 * @brief checks if a's values equal b's values, can be called as a static function Vec4.vequals( a, b )
	 * @param Vec4 a
	 * @param Vec4 b
	 * @return Boolean
	 */
        Vec4.vequals = Vec4.prototype.vequals = function( a, b ){
