...
define([
	 ...
	 * @return Boolean
	 */
        AABB3.prototype.intersect = function( other, out ){
            out || ( out = this );
	 ...
	 * @method aequals
	 * @memberof AABB3
	 * @brief checks if a's values equal b's values, can be called as a static function AABB3.aequals( a, b )
	 * @param AABB3 a
	 * @param AABB3 b
	 * @return Boolean
	 */
        AABB3.aequals = AABB3.prototype.aequals = function( a, b ){
