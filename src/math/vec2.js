...
define(
	 ...
	 * @return this
	 */
        Vec2.prototype.untransformMat3 = function( m ){
	    var me = m.elements,
		x = this.x, y = this.y;
            
            this.x = x * me[0] + y * me[1] + me[2];
            this.y = x * me[3] + y * me[4] + me[5];
	 ...
	 * @return this
	 */
        Vec2.prototype.untransformMat4 = function( m ){
	    var me = m.elements,
		x = this.x - me[12],
		y = this.y - me[13];
            
            this.x = x * me[0] + y * me[1] + me[2];
            this.y = x * me[4] + y * me[5] + me[6];
	 ...
	 * @method rotateMat32
	 * @memberof Vec2
	 * @brief transforms this with Mat32 rotation
	 * @param Mat32 m
	 * @return this
	 */
        Vec2.prototype.rotateMat32 = function( m ){
	    var me = m.elements,
		x = this.x, y = this.y;
        ...
        /**
	 * @method unrotateMat32
	 * @memberof Vec2
	 * @brief untransforms this with Mat32 rotation
	 * @param Mat32 m
	 * @return this
	 */
        Vec2.prototype.unrotateMat32 = function( m ){
	    var me = m.elements,
		x = this.x, y = this.y;
	 ...
	 * @return this
	 */
        Vec2.prototype.rotateMat4 = function( m ){
	    var me = m.elements,
		x = this.x, y = this.y;
            
            this.x = x * me[0] + y * me[4] + me[8];
            this.y = x * me[1] + y * me[5] + me[9];
	 ...
	 * @return this
	 */
        Vec2.prototype.unrotateMat4 = function( m ){
	    var me = m.elements,
		x = this.x, y = this.y;
	 ...
	 * @method vequals
	 * @memberof Vec2
	 * @brief checks if a's values equal b's values, can be called as a static function Vec2.vequals( a, b )
	 * @param Vec2 a
	 * @param Vec2 b
	 * @return Boolean
	 */
        Vec2.vequals = Vec2.prototype.vequals = function( a, b ){
